...
const english: Copy = {
  ...
  weapons: { eyebrow: 'Builds', title: 'Sephiria Weapons & Upgrade Paths', description: 'Six weapon branches, 200+ upgrades, and a build system designed around experimentation.', introTitle: 'How weapon builds work', intro: 'The exact weapon skill breakdown is待确认. This page records the researched scope without inventing weapon names, stats, or tier values.', familiesTitle: 'Weapon branches', familyRows: [{ weapon: 'Six weapon branches', bestOn: '待确认', notes: 'The research confirms six branches and 200+ weapon upgrades; individual branch names are待确认.' }, { weapon: 'Weapon upgrades', bestOn: 'All runs', notes: 'Plan routes around range, speed, damage style, and artifact/tablet synergies.' }, { weapon: 'Build combinations', bestOn: 'Solo or co-op', notes: 'Use verified artifacts, tablets, and animal synergies as they are documented.' }], swapTitle: 'Upgrade planning', swap: 'Compare six weapon branches and more than 200 upgrades, then plan a route that matches your preferred range, speed, and damage style.', jumpTitle: 'Jump to a section', bestTitle: 'What is confirmed', bestItems: ['Six weapon branches', '200+ weapon upgrades', 'Weapon, artifact, tablet, and animal synergies', 'Detailed item names and tier data: 待确认'], detailTitle: 'Weapon data table', detailIntro: 'The research file does not provide a verified weapon-by-weapon list. Unknown cells are intentionally marked 待确认.', detailRows: [{ tier: '待确认', weapon: '待确认', family: '待确认', rarity: '待确认', level: '待确认', className: '待确认', source: 'Official source required' }, { tier: '待确认', weapon: '待确认', family: '待确认', rarity: '待确认', level: '待确认', className: '待确认', source: 'Official source required' }] },
  grimoire: { eyebrow: 'Builds', title: 'Sephiria Build Planner — Grimoire', description: 'A research-grounded starting point for weapon, artifact, and tablet combinations.', paragraphs: ['The supplied research confirms that Sephiria revolves around weapons, artifacts, tablets, animal synergies, and run-by-run experimentation.', 'Specific Grimoire names, skill values, artifact effects, tablet effects, and recommended meta combinations are待确认. This article deliberately avoids fabricated build numbers or item names.'], sections: [{ title: 'Start with a clear run goal', body: 'Choose whether the run is focused on learning, clearing chapters, boss practice, co-op coordination, or Hard Mode preparation. The exact recommended route is待确认.' }, { title: 'Track synergies', body: 'Record weapon branches, artifacts, tablets, and animal synergies together so future build notes remain reproducible.' }, { title: 'Co-op planning', body: 'Online co-op supports up to four players. Party roles and exact co-op builds are待确认.' }, { title: 'Hard Mode', body: 'Hard Mode is documented as 60 levels. Enemy scaling, unlock requirements, and best builds are待确认.' }], relatedTitle: 'Related', related: ['Weapons & Upgrade Paths', 'Beginner Guide', 'Bosses & Co-op', 'Patch Notes'] },
