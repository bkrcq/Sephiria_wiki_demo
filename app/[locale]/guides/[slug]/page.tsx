...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; slug: string }> }) { const { locale, slug } = await params; if (!isLocale(locale)) return {}; const page = getKeywordPage(slug); return page ? keywordMetadata(page) : {} }
