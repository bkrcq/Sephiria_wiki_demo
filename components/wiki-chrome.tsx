...
export function WikiHeader({ locale, copy }: { locale: Locale; copy: Copy }) {
  ...
  const mainNav = [
    ...
    ['/guides/sephiria-coop', copy.nav.coop],
...
export function WikiFooter({ locale, copy }: { locale: Locale; copy: Copy }) {
  ...
  return <footer className="footer"><div className="footer-inner"><div className="footer-grid">
    ...
    <div><h3>{copy.footer.guides}</h3><ul><li><Link href={href('/weapons')}>{copy.nav.weapons}</Link></li><li><Link href={href('/weapons/grimoire')}>{copy.nav.builds}</Link></li><li><Link href={href('/guides/sephiria-coop')}>{copy.nav.coop}</Link></li><li><Link href={href('/guides')}>{copy.nav.guides}</Link></li></ul></div>
